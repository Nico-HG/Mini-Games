import { createPrompt, useState, useRef, useKeypress, usePrefix, isUpKey, isDownKey, isSpaceKey, isNumberKey, isEnterKey, Paginator, Separator, } from '@inquirer/core';
...
export default createPrompt((config, done) => {
    ...
    useKeypress((key) => {
        ...
        if (isEnterKey(key)) {
            ...
            setChoices(choices.map((choice) => isSelectableChoice(choice) ? { ...choice, checked: selectAll } : choice));
        }
        else if (key.name === 'i') {
            setChoices(choices.map((choice) => isSelectableChoice(choice) ? { ...choice, checked: !choice.checked } : choice));
        }
