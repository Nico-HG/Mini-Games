...
exports.default = (0, core_1.createPrompt)((config, done) => {
    ...
    (0, core_1.useKeypress)((key, rl) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        if ((0, core_1.isEnterKey)(key)) {
            rl.pause();
            (0, external_editor_1.editAsync)(value, (error, answer) => __awaiter(void 0, void 0, void 0, function* () {
                rl.resume();
                if (error) {
    ...
    if (status === 'loading') {
        message += chalk_1.default.dim(' Received');
    }
    else if (status === 'pending') {
        message += chalk_1.default.dim(' Press <enter> to launch your preferred editor.');
    }
    let error = '';
    if (errorMsg) {
